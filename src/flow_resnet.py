...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 24 18:26:05 2019
...
def rgb_resnet200_pretrained(pretrained=False, **kwargs):
...
model = rgb_resnet200_pretrained(pretrained = True)
#model = flow_resnet152(pretrained = True)
def main():
    m = 224
    n = 224
    c = 20
