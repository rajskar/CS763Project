...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 13:43:21 2019
...
def inception_v3(in_channels, pretrained=False, **kwargs):
...
#        print(original_aux_logits)
        model = Inception3(in_channels, **kwargs)                
        
        pretrained_dict = torch.load('/home/rajs/.torch/models/inception_v3_google-1a9a5a14.pth')
...
class Inception3(nn.Module):
    ...
    def __init__(self, in_channels, num_classes=1000, aux_logits=True, transform_input=False):
...
if __name__ == '__main__':
    model = inception_v3( in_channels = 20,pretrained = True, aux_logits = False)
    m = 299
    n = 299
    c = 20
    N = 1
    x = np.random.rand(N,m,n,c)
